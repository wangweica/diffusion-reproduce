...
res_dir = '/home/Data/zhangxiao/inr/models/all_inr_acdc_test/'

dataset_save_root = "/home/Data/zhangxiao/inr/out/inr2img_dataset_acdc_test/"
...
for fname in os.listdir(data_path):
    pname = fname.split('.')[0]
    model_name = f'{pname}_inr'
    model_path = os.path.join(res_dir, model_name + '.pth')
